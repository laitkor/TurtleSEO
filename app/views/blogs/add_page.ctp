...
<table width="93%" style="width: 100%;">
		<tbody>
			<tr>
				...
				<td width="982" valign="top"   bgcolor="#FFFFFF" align="left">
							
								<?php
								echo $form->create('',array('url' =>'add_page'));
								?>
								<?php
								...
								<table width="1052" height="248"  border="0" cellpadding="1" cellspacing="2" bgcolor="#FFFFFF" style="padding-left:0px">
								 <tr  >
									...
									<td width="124" height="38" colspan="3" align="left" bgcolor="#FFFFFF" style="background-color:#FFFFFF"><?php echo $crumb; ?></td>
						          </tr>
									
									<tr  >
										<td width="124" height="27" align="left" bgcolor="#FFFFFF" style="background-color:#FFFFFF"><strong>Select Server : </strong></td>
