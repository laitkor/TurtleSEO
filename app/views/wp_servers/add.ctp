...
<?php echo $crumb; ?> 
</td><td width="120" align="center"> <a href="javascript: openwindow('blog');" title="Help Video for blog">
...
<tr>
      <td height="28" colspan="2" bgcolor="#FFFFFF" align="left"><span class="style1" style="color:#CC6600">&nbsp;You have added <?php echo $total-$user_blog ." of " .$total ; ?> blogs. Remaining blogs: <?php echo $user_blog; ?>. 
...
?>
   ...
   <table>
   	<tr>
        ...
        <?php echo $html->link('Add Blogspot Blogs', array('controller'=>'blogs', 'action'=>'gdata/add' ), array('onclick'=>'return Popup.open({url:this.href});'));	?>
...
<li>Active
 ...
 <br><p class="grey10">Please <a href="javascript: openwindow('blog');">click here for help</a> or <a href='/users/support'>contact us</a> if you are facing difficulties in making this work.</p></li></td></tr> 
 </table>
