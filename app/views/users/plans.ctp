...
<table width="882px" cellpadding="0" border="0" align="center" style="background:#fff">
 <tbody>
   ...
   <div id="step_up_plan" style="display:none">
	...
	<tr>
      <td width="auto" height="32" bordercolor="#FFFFFF" bgcolor="#FFFFFF">Remaining from Last Plan:</td>
      <td width="18%" bordercolor="#FFFFFF" bgcolor="#FFFFFF">Blogs: <?php  echo $blog_to_del ;?></td>
      <td width="18%" bordercolor="#FFFFFF" bgcolor="#FFFFFF">Posts: <?php  echo $post_to_del ;?></td>
      <td width="18%" bordercolor="#FFFFFF" bgcolor="#FFFFFF">Pages: <?php  echo $page_to_del ;?></td>
      <td width="18%" bordercolor="#FFFFFF" bgcolor="#FFFFFF" >Reports: <?php  echo $report_to_del ;?></td>
     </tr>
     </table>
	 <p align="center">(Delete above number of respective entities to avail them.) </p>
     ...
     <tr class="odd">
      ...
      <td bordercolor="#00FF66"><?php echo $plan_limits['free']['blog_limit'];?> Blog </td>
      <td bordercolor="#00FF66"><?php echo $plan_limits['silver']['blog_limit'];?> Blogs </td>
      <td colspan="2" bordercolor="#00FF66"><?php echo $plan_limits['gold']['blog_limit'];?> Blogs  </td>
     </tr>
     <tr class="even" style="background:#EBEBEB;">
      <td height="19" bordercolor="#00FF66"><span class="style4"><strong>Pages</strong></span></td>
      <td bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['free']['page_limit'];?> Pages </span></td>
      <td bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['silver']['page_limit'];?> Pages</span></td>
      <td colspan="2" bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['gold']['page_limit'];?> Pages</span></td>
     </tr>
     <tr class="odd">
      <td height="21" bordercolor="#00FF66"><span class="style4"><strong>Posts</strong></span></td>
      <td bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['free']['post_limit'];?> Posts </span></td>
      <td bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['silver']['post_limit'];?> Posts </span></td>
      <td colspan="2" bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['gold']['post_limit'];?> Posts </span></td>
     </tr>
     <tr class="even" style="background:#EBEBEB;">
      <td height="19" bordercolor="#00FF66"><span class="style4"><strong>Reports </strong></span></td>
      <td bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['free']['report_limit'];?> Report </span></td>
      <td bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['silver']['report_limit'];?> Reports </span></td>
      <td colspan="2" bordercolor="#00FF66"><span class="style2"><?php echo $plan_limits['gold']['report_limit'];?> Reports</span></td>
     </tr>
     <tr class="odd">
