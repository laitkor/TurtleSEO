...
<p>
		You can sign-in by <a href="<?php echo "http://".$_SERVER['SERVER_NAME']."/users/sign_in_directly/$email/$password" ; ?>">clicking here directly </a>
		or go to this URL <?php echo "http://".$_SERVER['SERVER_NAME']."/users/sign_in/"; ?>   <br /><br />
